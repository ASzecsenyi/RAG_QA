...
class ExperimentChunkerAdmin(admin.ModelAdmin):
    list_display = ['chunker_name', 'id', 'experiment', 'chunk_length', 'sliding_window_size']
...
class ExperimentRankerAdmin(admin.ModelAdmin):
    list_display = ['ranker_name', 'id', 'experiment', 'top_k']
...
class ExperimentQAAdmin(admin.ModelAdmin):
    list_display = ['model_name', 'id', 'experiment']
